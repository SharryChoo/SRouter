...
/**
 * Thanks Alibaba, find out class with any conditions, copy from google source code.
 * Copy from galaxy sdk ${com.alibaba.android.galaxy.utils.ClassUtils}
 *
 * @author Sharry <a href="SharryChooCHN@Gmail.com">Contact me.</a>
 * @version 1.0
 * @since 2018/8/19 20:47
 */
public class ClassUtils {
    ...
    private static SharedPreferences getMultiDexPreferences(Context context) {
        return context.getSharedPreferences(PREFS_FILE, Build.VERSION.SDK_INT
                < Build.VERSION_CODES.HONEYCOMB ? Context.MODE_PRIVATE :
    ...
    public static Set<String> getFileNameByPackageName(Context context, final String packageName)
        ...
        parserCtl.await();
        Logger.e("Filter " + classNames.size() + " classes by packageName <" + packageName + ">");
        return classNames;
    }
    ...
    public static List<String> getSourcePaths(Context context) throws PackageManager.NameNotFoundException, IOException {
        ...
        //  如果VM已经支持了Multi Dex，就不要去Secondary Folder加载 Classesx.zip了，那里已经么有了
        //  通过是否存在sp中的 multi dex.version是不准确的，因为从低版本升级上来的用户，是包含这个sp配置的
    ...
    private static boolean isVMMultiDexCapable() {
        ...
        Logger.i("VM with name " + vmName + (isMultiDexCapable ? " has multidex support" :
